<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ProductList.ascx.cs" Inherits="NPetshop.Web.UserControls.Catalog.ProductList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
